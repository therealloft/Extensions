...
namespace Extensions
{
    ...
    public static class EnumInternal<T> where T : struct
	{
		...
		/// </summary>
		internal static readonly IDictionary<string, T> NameToValueMap = new Dictionary<string, T>();

		/// <summary>
		/// enum value -> enum name
		/// </summary>
		internal static readonly IDictionary<T, string> ValueToNameMap = new Dictionary<T, string>();

		/// <summary>
		/// enum value -> description
		/// </summary>
		internal static readonly IDictionary<T, string> ValueToDescriptionMap = new Dictionary<T, string>();

		/// <summary>
		/// enum description -> value
		/// </summary>
		internal static readonly IDictionary<string, T> DescriptionToValueMap = new Dictionary<string, T>();

		/// <summary>
		/// value int -> enum value
		/// </summary>
		internal static readonly IDictionary<int, T> ValueIntToValueMap = new Dictionary<int, T>();
